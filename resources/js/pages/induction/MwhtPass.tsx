      ...
      {slide === 0 ? (
        <>
          <Grid item xs={12} textAlign={'center'} py={1}>
            <ReactPlayer onEnded={showButton} style={{ margin: '0 auto', width: '100%', maxWidth: 'calc(100vw - 16px)' }} controls={true} url='https://youtu.be/PeY9pWJ2Mbk?si=b0ljY-XEi14QrVVr' />
          </Grid>
          <Grid item xs={12} textAlign={'center'} py={1}>
        ...
        <>
          <Grid item xs={12} textAlign={'center'} py={1}>
            <ReactPlayer onEnded={showButton} style={{ margin: '0 auto', width: '100%', maxWidth: 'calc(100vw - 16px)' }} controls={true} url='https://youtu.be/Aa4mm_OGL34?si=EfVypsICPwYQQXac' />
          </Grid>
          <Grid item xs={12} textAlign={'center'} py={1}>
        ...
        <>
          ...
          <Grid item xs={12} py={1} px={1} textAlign="center">
            <Typography variant='body1' component='p'>You have passed MWHT PassPort Induction</Typography>
          </Grid>
          <Grid item xs={12} textAlign={'center'} py={1}>
